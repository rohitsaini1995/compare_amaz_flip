...
class Flipkart
{
    ...
    private $api_base = 'https://affiliate-api.flipkart.net/affiliate/search/';
     ...
     * @return void
     **/
    function __construct($affiliateId, $token, $response_type="xml")
    {
        ...
        $this->api_base.= $this->response_type;
    }
